public class Project_Enums
{
    ...
    public enum ITEM {DEFAULT, VEGETATION, BUILDING_EQUIPMENT, CGI_EXPERTISE, VIDEO_EQUIPMENT, IOT_DEVICES,
                        MARKETING_EXPERTISE, FREE, OTHER};
    public enum PROJECT_TYPE {DEFAULT};
}
